...
$__spDesc = [
  'SP1' => ['sub'=>'<strong>Surat Peringatan Pertama (SP1).</strong> Pelanggaran mencapai tahap yang memerlukan teguran tertulis resmi & pendampingan wali kelas.','tindakan'=>'Penerbitan SP1 tertulis; pemanggilan & pertemuan dengan orang tua/wali; peserta didik membuat surat pernyataan komitmen perbaikan.','tujuan'=>'Menghentikan pelanggaran berulang melalui kolaborasi sekolah–orang tua dan komitmen tertulis peserta didik.','catatan'=>'Wali kelas memantau perilaku selama periode tertentu; saldo poin dapat membaik dengan mengumpulkan prestasi.'],
  'SP2' => ['sub'=>'<strong>Surat Peringatan Kedua (SP2).</strong> Pelanggaran berlanjut meski telah menerima SP1; memerlukan keterlibatan Guru BK & rencana perbaikan terukur.','tindakan'=>'Penerbitan SP2; pemanggilan kedua orang tua/wali bersama Guru BK; penyusunan rencana perbaikan (action plan) dengan target & tenggat.','tujuan'=>'Perubahan perilaku berkelanjutan yang terukur, dengan pengawasan BK dan dukungan orang tua.','catatan'=>'Evaluasi berkala kemajuan; bila pelanggaran berlanjut berisiko naik ke SP3.'],
  'SP3' => ['sub'=>'<strong>Surat Peringatan Ketiga (SP3).</strong> Pelanggaran serius/berulang; memerlukan pembinaan khusus terpadu & pengawasan ketat.','tindakan'=>'Penerbitan SP3; program pembinaan terstruktur (coaching/konseling intensif oleh BK); pemantauan ketat & komunikasi rutin dengan orang tua.','tujuan'=>'Koreksi perilaku menyeluruh dengan pengawasan ketat sebelum tindakan tegas.','catatan'=>'Pelanggaran lanjutan berisiko naik ke SP4 (peringatan terakhir).'],
  'SP4' => ['sub'=>'<strong>Surat Peringatan Keempat (SP4) — peringatan terakhir.</strong> Memerlukan sidang/konferensi kasus & keputusan tindak lanjut.','tindakan'=>'Penerbitan SP4; konferensi kasus (sekolah, BK, wali kelas, orang tua); penetapan sanksi tegas & monitoring harian.','tujuan'=>'Keputusan tindak lanjut terakhir sebelum kemungkinan pemulangan ke orang tua.','catatan'=>'Dapat berdampak akademik (mis. tidak naik kelas); pelanggaran lanjutan berujung pengembalian ke orang tua.'],
];
