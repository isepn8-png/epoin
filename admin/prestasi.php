            ...
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header" style="background:linear-gradient(90deg,#dbeafe,#fff); border-bottom:1px solid #bfdbfe;">
                  ...
                  <h4 class="modal-title"><i class="fa fa-file-excel-o" style="color:#2563eb"></i> Import Prestasi dari Excel</h4>
                </div>
                  ...
                  <div class="modal-body">
                    ...
                    <ol style="padding-left:18px; color:#334155; font-size:13px;">
                      <li>Unduh template dulu:
                        <a href="kategori_template.php?jenis=prestasi" class="btn btn-xs btn-default"><i class="fa fa-download"></i> Template Excel</a>
                      </li>
                      <li>Isi kolom <b>A = Nama Kategori</b>, <b>B = Poin</b> (angka positif). Baris 1 adalah judul.</li>
